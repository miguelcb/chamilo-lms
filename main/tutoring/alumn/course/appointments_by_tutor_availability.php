...
<<<<<<< HEAD:main/tutoring/alumn/course/appointments_by_tutor_availability.php
    $('[data-appointment-id]').click(function() {
        ...
        $.ajax({
            ...
            data: {
                uid: Course.USER_ID,
=======
    $('#appointments-by-tutor-availability [data-appointment-id]').off().click(function() {
        if (!window.confirm("¿Desea reservar cita?")) return;
        var $sup = $(this);
        $.ajax({
            url: VLMS.URI + 'course/appointments_register.php',
            data: {
                uid: VLMS.USER_ID,
>>>>>>> danilobrinu/winter16:main/tutoring/alumn/course/appointments_by_tutor_availability.php
